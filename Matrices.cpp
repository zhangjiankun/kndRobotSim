...
///////////////////////////////////////////////////////////////////////////////
/*
translate() produces the current matrix translated by (x, y, z). First, it create a translation matrix, MT,
then multiply it with the current matrix object to produce the final transform matrix:
Note that this function is equivalent to OpenGL's glTranslatef(), but OpenGL uses post multiplication instead of
pre-multiplication (The translation matrix is multiplied back of the current matrix.). If you apply multiple
transforms, then the result is significantly different because matrix multiplication is not commutative.
*/
