...
inline void Matrix4::setPositionX(float x)
{
    m[3] = x;
}

inline void Matrix4::setPositionY(float y)
{
    m[7] = y;
}
...
inline float Matrix4::getPositionY() { return m[7]; }
inline float Matrix4::getPositionZ() { return m[11];}
